...
import { Search, PlusCircle, Filter, CheckCircle, AlertCircle, Clock, Home, Eye, Edit, Trash2, FileText, Flag, MapPin, Star, Heart, MessageSquare, DollarSign, Bed, Bath, Building, ChevronLeft } from 'lucide-react';
...
const EstateManagement = () => {
  ...
  return (
    <div className="estate-management">
      ...
      {/* Estate Detail Modal */}
      {showDetailModal && <EstateDetailModal estate={selectedEstate} onClose={() => setShowDetailModal(false)} />}
    </div>
  );
};
